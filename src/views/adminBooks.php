                ...
                if ($authors == 0 && $Books == 0) {
                    ...
                    foreach ($Books as $Book) {
                            ...
                            <div class="content" id="page">
                                    ...
                                    <a href="adminBooks.php?bookId=<?php echo $Bookid; ?>" onclick="return confirm('Are you sure you want to delete this book?');">
